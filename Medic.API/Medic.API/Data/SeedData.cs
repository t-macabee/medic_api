    ...
    public static class SeedData
    {
        ...
        public static void SeedUsers(ModelBuilder builder)
        {
            ...
            builder.Entity<User>().HasData(
                ...
                new User { Id = 2, Name = "Jane Doe", Username = "janedoe", PasswordHash = employeeHash, PasswordSalt = employeeSalt, RoleId = 2, DateOfBirth = new DateTime(1997, 6, 15), LastLogin = DateTime.Now, Orders = 6, ImageUrl = "https://randomuser.me/api/portraits/women/39.jpg", Status = "Active" }
            );
        }
    }
}
