    ...
    public static class SeedData
    {
        ...
        public static void SeedUsers(ModelBuilder builder)
        {
            ...
            builder.Entity<Users>().HasData(
                new Users { Id = 1, Name = "John Doe", Username = "admin", PasswordHash = adminHash, PasswordSalt = adminSalt, RoleId = 1, DateOfBirth = new DateTime(1996, 7, 29), LastLogin = DateTime.Now, Orders = 0, ImageUrl = "", Status = "Active" },
                new Users { Id = 2, Name = "Jane Doe", Username = "janedoe", PasswordHash = employeeHash, PasswordSalt = employeeSalt, RoleId = 2, DateOfBirth = new DateTime(1997, 6, 15), LastLogin = DateTime.Now, Orders = 6, ImageUrl = "", Status = "Active" }
            );
        }
    }
}
